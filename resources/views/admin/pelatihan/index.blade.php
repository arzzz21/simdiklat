...
<div class="card"> <div class="card-header d-flex justify-content-between align-items-center"> <h5>Daftar Pelatihan</h5> <a href="{{ route('admin.pelatihan.create') }}" class="btn btn-primary btn-sm">+ Tambah Pelatihan</a> </div> <div class="card-body"> @if (session('success')) <div class="alert alert-success">{{ session('success') }}</div> @endif
