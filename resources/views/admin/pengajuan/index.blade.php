      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            @elseif ($p->status === 'terverifikasi' && !$p->invoice)
                <a href="{{ route('admin.invoice.create', $p->id) }}" class="btn btn-sm btn-warning">Terbitkan Invoice</a>
            @endif
            <!-- Modal -->
